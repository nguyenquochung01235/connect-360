...
const validateUserCreateForm = () => {
    if (DOMstrings.usernameField.value != "" && DOMstrings.passwordField.value != "" && DOMstrings.repasswordField.value != "") {
...
DOMstrings.usernameField.addEventListener("keyup", e => {
...
$('#submit-create-user-btn').on('click', function (e) {
    ...
    $.ajax({
        ...
        url: "/admin/panel/user-management/create",
        type: "POST",
        data: formData,
        encode: true,
        success: function (response) {
